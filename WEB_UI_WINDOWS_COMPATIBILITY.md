...
Выбранная схема: TypeScript + CSS собираются локально в статические файлы ES5/совместимого JavaScript; C# .NET Framework 4.8 остаётся native shell и bridge для BuildService, Java/Minecraft launch, settings и auto-update; CefSharp/CEF 109 отображает только локальный UI. Переход на CEF сделан после проверки: встроенный WinForms WebBrowser под Wine дал белое окно и не является достаточной проверкой реального UI.
